...
```
- [Open Admin Dashboard](https://admin-dashboard-demo.onrender.com/)
  

## 🎥 Flexair Demo Video
- [Download Flexair demo video](https://github.com/frimoss/flexair-ios/raw/main/app-shots/demo.mp4)
